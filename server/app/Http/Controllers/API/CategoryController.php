...
class CategoryController extends Controller
{
    ...
    /**
     * Display every clients categories
     * @unauthenticated
     */
    ...
    public function index(Request $request)
    {
        ...
        return 
        /**
         * Returns every clients categories in the database. The clients tokens will be displayed if you are authenticated.
    ...
    public function store(Request $request)
    {
        ...
        return 
        /**
         * Returns the client category with its brands.
